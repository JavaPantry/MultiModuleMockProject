Ext.define('Fast.view.sales.forecast.weekActuals.WeekActualsApprovalGrid' ,{
			extend: 'Fast.view.sales.forecast.week.WeekBaseGrid'//extend: 'Ext.grid.Panel'
		    ,id : 'WeekActualsApprovalGrid'
		    ,alias :'widget.WeekActualsApprovalGrid'
			...
			,initComponent: function() {
				this.dockedItems = [{xtype: 'toolbar', dock:'top',
										items: [
												...
												,{text : 'Approve', minWidth : 80,iconCls : 'icon-check1',action : 'approveWeekActualsForecast',actionCommand : 'Approving'}
												,{text : 'Rework', minWidth : 80,iconCls : 'icon-return',action : 'reworkWeekActualsForecast',actionCommand : 'ReWork'}
										        ]}
